...
class IntroductionScene(Scene):
    ...
    def render(self):
        ...
        button.standard_button(Rectangle(int(SCREEN_WIDTH * 0.75), int(SCREEN_WIDTH / 2) - self.slime_sprite.width, 150,60), 2, GRAY, BLACK, "NEXT", get_font_default(), navigate_to_park)
